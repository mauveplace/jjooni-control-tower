...
@media(max-width:760px){.latestBoardWrap{padding:0 10px;margin-top:9px}.latestBoardHead{align-items:flex-start}.latestBoardHead>div{display:block}.latestBoardHead>div span{display:block;margin-top:2px}.latestBoardGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.latestTile{padding:8px 9px}.latestTile strong{font-size:17px}.latestTileFoot{font-size:8px}}
