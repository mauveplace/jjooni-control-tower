...
const BOOT={state:'WAITING_FOR_SSOT',version:'14.24',started_at:new Date().toISOString(),loaded:[],failed:null,nav_owner:'TRADE_REVIEW_LOADER_V14',preload_token:String(Date.now())};
