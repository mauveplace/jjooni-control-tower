...
function loadMetricRouterCore(){load('ctMetricDrillV12Script','metric-drilldown-router-v12.js?v=12.0',null,()=>{window.__JJOONI_METRIC_DRILL_V12={state:'LOAD_FAILED'};window.__JJOONI_METRIC_DRILL_V11={state:'LOAD_FAILED'}})}
function loadMetricRouter(){load('ctCanonicalValuationV13Script','canonical-valuation-fix-v13.js?v=13.0',loadMetricRouterCore,()=>{window.__JJOONI_CANONICAL_VALUATION_V13={booted:true,state:'LOAD_FAILED',version:'13.0'};loadMetricRouterCore()})}
