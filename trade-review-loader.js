...
const BOOT={state:'WAITING_FOR_SSOT',version:'14.27',started_at:new Date().toISOString(),loaded:[],failed:null,nav_owner:'TRADE_REVIEW_LOADER_V14',preload_token:String(Date.now())};
...
['ctDrilldownReadabilityV19Script','drilldown-readability-v19.js?v=19.3','drilldown-readability'],
